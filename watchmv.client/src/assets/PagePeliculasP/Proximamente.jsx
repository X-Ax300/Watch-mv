...
function Proximamente() {
    ...
    const fetchMovies = (page) => {
        ...
        fetch(`https://api.themoviedb.org/3/movie/upcoming?language=${selectedLanguage}&page=${page}`, options)
    ...
    return (
        <div className='container'>
                ...
                <nav className='navbar'>
                    ...
                    <div className='nav_item'>
                        ...
                        <select
                            ...
                            style={{ backgroundColor: 'black', color: 'white', border: 'none' }}
                            onChange={(event) => {
                                if (event.target.value === "popularesS") {
                    ...
                    <div className='nav_item'>
                        ...
                        <select
                            ...
                            style={{ backgroundColor: 'black', color: 'white', border: 'none' }}
                            onChange={(event) => {
                                if (event.target.value === "GentePopulares") {
                    ...
                    <div className='nav_item'>
                        <p className="LanguageComming">{selectedLanguage === 'en' ? 'Language' : 'Lenguaje'}</p>
            ...
            <div className='container'>
                <h1 className='title'>{selectedLanguage === 'en' ? 'Upcoming Movies' : 'Peliculas Proximamente'}</h1>
